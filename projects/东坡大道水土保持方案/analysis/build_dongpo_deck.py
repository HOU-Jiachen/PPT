...
def table_points_from_context(page: dict[str, Any], evidence: list[dict[str, Any]], max_points: int = 4) -> list[str]:
    ...
    library: list[tuple[list[str], list[str]]] = [
        (
            ["综合报告表", "全局控制"],
            [
                "综合报告表集中列示建设内容、占地、土石方、防治目标、措施和投资控制指标。",
                "工程规模、责任范围与投资口径在综合报告表中保持统一控制关系。",
                "土石方平衡、预测计算、措施布设和投资概算均以综合表控制参数为依据。",
            ],
        ),
        (
            ["工程特性", "规模", "工期"],
            [
                "工程特性表明确项目性质、建设规模、投资组成、施工时段和占地口径。",
                "建设规模和工期决定扰动持续时间，是水土流失预测和措施进度安排的基础。",
                "管网工程区作为防治分区覆盖项目建设活动和临时占地范围。",
            ],
        ),
        (
            ["责任范围", "临时占地"],
            [
                "防治责任范围落实到管网工程区，方案责任边界与工程占地口径一致。",
                "临时占地范围纳入措施布设、投资估算和效益分析的统一控制。",
                "管线、施工场地、顶管井和恢复范围共同构成水土保持管理对象。",
            ],
        ),
        (
            ["防治指标", "一级标准"],
        ...
        (
            ...
            [
                ...
                "项目选址与建设方案未见水土保持法、长江保护法或技术标准禁止性因素。",
                "评价结论为土石方、施工组织和措施体系提供前置依据。",
            ],
        ),
        (
            ["土石方平衡", "弃方", "借方"],
        ...
        (
            ...
            [
                ...
                "背景值体现工程建设相对于原地貌状态的新增扰动贡献。",
                "取值来源、计算口径与报告公式共同形成预测参数体系。",
            ],
        ),
        (
            ["施工期扰动", "侵蚀模数"],
        ...
        (
            ...
            [
                ...
                "进度表保留道路段、工序和年月层级关系，体现分段施工与分段恢复安排。",
                "临时防护与扰动活动同步展开，恢复措施跟随路面和绿化恢复完成。",
            ],
        ),
        (
            ["估算总投资", "投资"],
        ...
        (
            ...
            [
                ...
                "各费用类别对应不同实施责任和验收材料，形成新增投资分类管理口径。",
                "费用类别摘录保留工程措施、植物措施、临时措施和独立费用的构成关系。",
            ],
        ),
        (
            ["补偿费", "免征"],
            [
                ...
                "计算基础与政策免征结论分别列示，形成补偿费管理口径。",
                "免征依据、项目性质和责任主体表述保持一致。",
            ],
        ),
        (
            ["防治效果", "目标值"],
    ...
    fallback = [
        f"表格内容对应“{chapter or '报告'}”章节的关键工程口径。",
        "表格说明提炼原表在章节中的工程作用，具体数值保留在表内证据中。",
        "多级表头或合并单元格保留层级关系、单位口径和分组含义。",
    ]
    for ev in evidence:
